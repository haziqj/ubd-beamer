---
title: UBD40 Beamer Theme using RMarkdown
...
- [UBD40 Deep Red: `ubdrubydeep` (#B71757)]{color=ubdrubydeep}
- [UBD40 Bright Red: `ubdrubybright` (#E81856)]{color=ubdrubybright}
- [UBD40 Soft Red: `ubdrubysoft` (#F05A91)]{color=ubdrubysoft}
...
The font for UBD40 typography is Avenir Next, which is a sans-serif typeface.
The `.otf` files are included in the `fonts/` folder.
...
Compiling using Xe\LaTeX\ is required to use the fonts via the `fontspec` package.
...
::: {.block}
#### For non-Rmd beamer
All you need is 1, 4, and 5 (the Rmd template and lua filters are not necessary).
